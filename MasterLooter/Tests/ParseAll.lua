...
local files = {
    ...
    "MasterLooter/Modules/Commands.lua", "MasterLooter/UI/Theme.lua", "MasterLooter/UI/RollWindow.lua",
    ...
    "MasterLooter/UI/BagInspectorWindow.lua", "MasterLooter/UI/NativeLootWindow.lua",
    "MasterLooter/UI/LootWindow.lua", "MasterLooter/UI/TradeWindow.lua", "MasterLooter/UI/RulesWindow.lua",
