...
- Das Item im Teilnehmerfenster unterstützt Shift-Hover für native Ausrüstungsvergleiche sowie Blizzards modifizierte Itemklicks, einschließlich STRG-Klick für die Vorschau.
...
- Raidmitglieder können ihre eigenen SoftRes mit `SR` und ihren manuellen Strichstand mit `SL` ausschließlich per Whisper beim aktiven Master Looter abfragen; Sonderzeichen-Aliase bleiben kompatibel, sofern Ascension sie zustellt.
