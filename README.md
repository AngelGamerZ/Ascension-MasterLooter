...
The current integration harness covers two isolated addon clients and 174 assertions across communication, queued rolls, awards, trades, rules, GDKP, auctions, bag inspection, and item data.
